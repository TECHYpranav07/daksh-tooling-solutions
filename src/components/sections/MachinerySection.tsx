...
const MACHINES: Machine[] = [
  ...
  // Injection Molding
  {
    ...
    make: 'MILACRON',
    category: 'molding',
    categoryLabel: 'INJECTION MOULDING',
    spec: 'Tonnage: 180 Ton | Platen: 510 × 510 mm | Shot: 336g',
    image: '/images/machinery/milacron_180t.jpg',
    description: 'High-tonnage horizontal moulding machine for engineering plastic parts and automotive components.',
  ...
  },
  {
    ...
    description: 'Precision horizontal injection moulding unit for general and engineering grade thermoplastics.',
  ...
  },
  {
    ...
    description: 'Versatile injection moulding machine for plastic housings, brackets, and automotive interior trim.',
  ...
  },
  {
    ...
    description: 'Precision injection moulding machine for compact components, technical bushings, and high-tolerance parts.',
  ...
  },
  {
    ...
    description: 'Vertical rotary clamping system specialized for insert over-moulding of stamped metal terminals into plastics.',
    highlights: ['Rotary Table Insert Moulding', 'Metal-to-Plastic Overmoulding', 'Hybrid Assembly'],
    qty: '02 Units',
    capacity: '50%',
  },
  {
    ...
    description: 'Precision vertical rotary injection moulding machine for micro insert moulding and delicate terminal assemblies.',
    highlights: ['Micro Insert Moulding', 'Vertical Clamping Precision', '50% Free Capacity'],
    qty: '01 Unit',
    capacity: '50%',
  },
...
const CATEGORIES = [
  ...
  { key: 'molding', label: 'INJECTION MOULDING', count: 6 },
