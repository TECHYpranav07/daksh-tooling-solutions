    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '11px', letterSpacing: '0.3em', color: 'oklch(0.78 0.12 215)', marginBottom: '0.3rem' }}>
            {code}
          </div>
          <div style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '11px', letterSpacing: '0.2em', color: 'oklch(0.55 0.01 250)' }}>
            {machine}
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <div style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '11px', letterSpacing: '0.45em', color: 'oklch(0.72 0.19 45)', marginBottom: '0.35rem' }}>
              STEP {String(s.step).padStart(2, '0')} / 10
            </div>
            <h2 style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: '1.5rem', fontWeight: 700, letterSpacing: '-0.02em', color: 'oklch(0.93 0.005 250)', margin: 0 }}>
              {s.title}
            </h2>
            <div style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '11px', letterSpacing: '0.25em', color: 'oklch(0.78 0.12 215)', marginTop: '0.25rem' }}>
              {s.operation}
            </div>
          </div>
        ...
        <div style={{ position: 'relative', width: '100%', aspectRatio: '16/9', overflow: 'hidden', flexShrink: 0, background: 'oklch(0.18 0.012 250)' }}>
          ...
          <div style={{ position: 'absolute', bottom: '1rem', left: '1.25rem', display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            <span style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '10px', letterSpacing: '0.35em', color: 'oklch(0.72 0.19 45)', border: '1px solid oklch(0.72 0.19 45 / 0.5)', background: 'oklch(0.14 0.012 250 / 0.8)', padding: '0.25rem 0.625rem', backdropFilter: 'blur(8px)' }}>
              {s.code}
            </span>
            <span style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '10px', letterSpacing: '0.2em', color: 'oklch(0.78 0.12 215)', border: '1px solid oklch(0.78 0.12 215 / 0.3)', background: 'oklch(0.14 0.012 250 / 0.8)', padding: '0.25rem 0.625rem', backdropFilter: 'blur(8px)' }}>
              {s.machine}
            </span>
          </div>
        </div>
        ...
        <div style={{ padding: '1.5rem 1.75rem 2.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          {/* Description */}
          <p style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: '0.9375rem', lineHeight: 1.7, color: 'oklch(0.78 0.005 250)', margin: 0 }}>
            {s.description}
          </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem' }}>
            {s.specs.map((spec) => (
              ...
              >
                <div style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '10px', letterSpacing: '0.2em', color: 'oklch(0.62 0.01 250)', marginBottom: '0.25rem' }}>
                  {spec.label}
                </div>
                <div style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '12px', color: 'oklch(0.78 0.12 215)', fontWeight: 600 }}>
                  {spec.value}
                </div>
              </div>
            ))}
          ...
          {/* Technical details */}
          <div>
            <div style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '11px', letterSpacing: '0.35em', color: 'oklch(0.72 0.19 45)', marginBottom: '0.875rem' }}>
              TECHNICAL BREAKDOWN
            </div>
            <ul style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
              {s.details.map((detail, i) => (
                <li key={i} style={{ display: 'flex', gap: '0.625rem', alignItems: 'flex-start' }}>
                  ...
                  <span style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: '0.875rem', lineHeight: 1.65, color: 'oklch(0.72 0.005 250)' }}>
                    {detail}
                  </span>
                </li>
              ))}
          ...
          {/* Hint */}
          <div style={{ fontFamily: '"JetBrains Mono", ui-monospace, SFMono-Regular, monospace', fontSize: '10px', letterSpacing: '0.2em', color: 'oklch(0.62 0.01 250 / 0.45)', textAlign: 'center', paddingTop: '0.25rem' }}>
